...
class Game:
    def __init__(self):
        ...
        self.player_name = input("Введите ваше имя: ")  # Запрос имени игрока
    ...
    def save_score_to_db(self):
        try:
            ...
            cur.execute("INSERT INTO SNAKE_GAME (user_name, user_score) VALUES (%s, %s);", (self.player_name, self.snake.score))
            self.db_conn.commit()
