...
# Определение констант для размеров экрана
SCREEN_WIDTH = 800
SCREEN_HEIGHT = 600
...
# Загрузка изображений для кнопок проигрывания и паузы
...
# Индекс текущей играющей песни и список путей к файлам музыки
...
# Список путей к обложкам альбомов и размер альбомной обложки
COVERS = ['img/cover/11.jpg', 'img/cover/22.jpg', 'img/cover/33.jpg']
...
while running:
    ...
    pygame.draw.rect(game_display, LIGHT_GRAY, (SCREEN_WIDTH // 2 - ALBUM_COVER_SIZE // 2, 342, ALBUM_COVER_SIZE, 11))
    if play:
        x += 0.1
